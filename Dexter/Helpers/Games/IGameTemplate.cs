...
namespace Dexter.Helpers.Games {
    ...
    public interface IGameTemplate {
        ...
        /// </summary>
        /// <param name="Context">The command context, which includes the sent message.</param>
        ...
        public abstract Task HandleMessage(SocketCommandContext Context, DiscordSocketClient Client, FunConfiguration FunConfiguration);
        ...
        /// <param name="Error">In case this operation wasn't possible, its reason.</param>
        /// <returns><see langword="true"/> if the operation was successful, otherwise <see langword="false"/>.</returns>

        public abstract bool Set(string Field, string Value, out string Error);
